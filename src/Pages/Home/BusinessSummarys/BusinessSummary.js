...
const SingleBusinessSummary = ({ heading, icon, number }) => {
    return (
        <div className="flex justify-center my-5">
            <div className="rounded-lg shadow-xl bg-gradient-to-b from-dark-sky-blue to-sky-blue max-w-sm pt-10 w-64 text-white">
                <div>
                ...
                <div className="px-3 py-5">
                    ...
                    <p className="text-3xl font-medium mb-4 font-headings text-center">
                        {heading}
                    </p>
                </div>
            </div>
