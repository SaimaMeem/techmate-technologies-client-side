            ...
            <div className="flex justify-center py-4">
                <div className="rounded-lg shadow-lg bg-white max-w-sm border-2">
                    <div className='grid grid-cols-2 px-3 pt-5'>
                        ...
                        <div className='text-left pl-3 lg:h-52 xl:h-auto items-center'>
                            <div className='pt-10'>
                                <h5 className="text-black text-2xl font-bold mb-1 text-left">{name}</h5>
                                <h5 className="text-black text-xl font-bold mb-2">Price: <span className='text-base'>${price}</span> <span className='text-xs font-semibold text-gray-800'>&nbsp; per unit</span></h5>
                            </div>

                        </div>
                    </div>
                    <div className="px-6 pb-6 pt-1">
                        <h5 className="text-black text-base font-bold mb-2">Quantity: <span className='text-base font-medium'> {available_quantity}</span> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; Minimum Quantity:<span className='text-base font-semibold'> {min_quantity}</span></h5>
