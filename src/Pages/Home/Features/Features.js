import { faBagShopping, faPlaneDeparture, faSackDollar, faShield, faShieldAlt, faUsers } from '@fortawesome/free-solid-svg-icons';
...
const Features = () => {
    return (
        ...
        <section className='grid grid-cols-1 lg:grid-cols-4 sm:grid-cols-2 py-6 gap-3 bg-light-yellow justify-center items-center'>
