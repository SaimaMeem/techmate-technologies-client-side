    ...
    return (
        <section className='px-10'>
            <div class="flex justify-around">
                <div class="grid grid-cols-1 md:grid-cols-5 flex-col-reverse md:flex-row bg-white">

                    <div class="p-6 flex flex-col justify-start col-span-3">
                    ...
                    <img class=" w-full h-72 md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg" src="https://mdbootstrap.com/wp-content/uploads/2020/06/vertical.jpg" alt="" />
                </div>
            </div>
        </section>
    );
